...
export const featuresData = [
    {
        ...
        title: 'Smart Upload',
        desc: 'Drag and Drop your assets, we auto-optimize for best results based on your goals and content.'
    },
    {
        icon: <ZapIcon className="w-6 h-6" />,
        title: 'Instant Generation',
        desc: 'Optimized models deliver output in seconds with great feasibility and quality.'
    },
    {
        icon: <VideoIcon className="w-6 h-6" />,
        title: 'Video Synthesis',
        desc: 'Bring Product Shots to life with short-form, social-ready videos for ads, reels and more.'
    }
];
