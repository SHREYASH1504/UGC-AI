  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        <Title
          heading="Create In-Context Page"
          ...
          <div className="w-full">
            <div className="mb-4 text-gray-300">
              ...
              <input
                ...
                required
                className="w-full bg-white/3 wounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all"
              />
            </div>
            ...
            <div className="mb-4 text-gray-300">
              ...
              >
                Product Description
                <span className="text-ex text-violet-400">(optional)</span>
              </label>
              ...
              <textarea
                ...
                className="w-full bg-white/3 wounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"
              ></textarea>
            </div>
